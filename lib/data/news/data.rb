module FGFC
  module News
    ...
    @news << {
        ...
        para1: 'Forest Glade U11 Black are looking for additional players for this season.',
        para2: 'We play in the Southend and District Youth League division "E". All our coaches are CRB checked. We have a great bunch of lads in the squad and just need one or two more players. You need to have experience of playing within a team and be in school year 6. We train every Saturday morning at Barleylands.',
        para3: 'If interested please contact Nick Bailey on 07751 344644 or email nandkbailey@sky.com'
    }
    @news << {
        type: 'team',
        heading: "U12 White - Goalkeeper Wanted",
        para1: 'Goal keeper required  to play for Forest Glade FC U12.',
    ...
    @news << {
        type: 'team',
        heading: "U11 White - Players Wanted",
        para1: 'We are looking for additional players for the upcoming season. We currently play in the South East Essex League Div A.',
    ...
    @news << {
        type: 'team',
        heading: "U11 White - Coach Wanted",
    ...
    @news << {
        ...
        para1: "Forest Glade U12 Red are looking for players for the new season.",
        para2: 'This is for boys in school year 7.',
    ...
    @news << {
        ...
        para1: "Forest Glade U15 Blue are looking for experienced outfield players moving into school year 10 in Sept 2014 to boost their squad.",
    ...
    @news << {
        ...
        para1: "The U12 White's are currently looking for players for the new season.",
    ...
    @news << {
        ...
        para1: 'The U10 Tigers are currently looking for players for the new season.',
