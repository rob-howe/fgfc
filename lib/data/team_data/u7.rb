module FGFC
  module TeamData
    ...
    @team_data[:u7lions] = {
        ...
        coaches: [{name: 'Steve Cross',
                   contact: ['07765 886171']}
        ],
        squad: [
        ],
        photos: [''],
    ...
    @team_data[:u7leopards] = {
        name: 'U7 Leopards',
        league: 'South East Essex Primary League',
        division: 'Group 1',
        manager: {name: 'Mick Broadbent',
                  contact: ['07504 097981']
        },
        coaches: [{name: 'Dean Marks',
                   contact: ['07818 071716']}
        ],
        squad: [
        ],
        photos: [''],
        ...
        sponsors: [{url: 'http://www.kwik-fit.com', logo: 'kwik-fit.png', name:'Kwit Fit'},
                   ...
                   {url: 'https://twitter.com/twistedhandb', logo: 'twisted-hair.png', name:'Twisted Hair & Beauty'},
    ...
    @team_data[:u7panthers] = {
        name: 'U7 Panthers',
        league: 'South East Essex Primary League',
        division: 'Group X',
        manager: {name: 'Matt Temple',
                  contact: ['07557 259542']
        },
        coaches: [{name: '',
                   contact: ['']}
        ],
